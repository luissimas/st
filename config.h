 ...
 */
static char *font = "Fira Code Nerd Font:style=Medium:pixelsize=13:autohint=true";
static char *font2[] = {
	"Hack Nerd Font:pixelsize=14:autohint=true", 
};
...
static const char *colorname[] = {
	...
	"#D8DEE9", // foreground and cursor color
};
*/
